# Inherit device configuration for p4wifi_hc.
$(call inherit-product, device/samsung/p4wifi_hc/p4wifi_hc.mk)
...
#
PRODUCT_NAME := omni_p4wifi_hc
PRODUCT_BRAND := samsung
PRODUCT_DEVICE := p4wifi_hc
...
PRODUCT_RELEASE_NAME := p4wifi_hc
